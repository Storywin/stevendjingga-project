      ...
      <div className="relative z-10">
        ...
        <header className="max-w-5xl mx-auto text-center px-4 pt-32 pb-24 relative">
          <FadeIn>
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-8 uppercase tracking-tight leading-tight bg-clip-text text-transparent bg-gradient-to-b from-white via-white to-gray-500">
              BISNIS HACKS UNTUK <br/> DAPATKAN HINGGA 1M <br/>
          ...
          <div className="flex flex-col md:flex-row items-center gap-12 mb-32 relative">
            ...
            <div className="flex-1 w-full pl-8 md:pl-0 md:pr-12">
               <FadeIn className="aspect-[4/3] rounded-2xl border border-white/10 bg-gray-900/50 flex items-center justify-center overflow-hidden relative group">
                  ...
                  <span className="text-2xl font-bold text-white/20 group-hover:text-white/40 transition-colors">FOTO 1</span>
                  {/* Placeholder for actual image */}
                  <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1552664730-d307ca884978?q=80&w=2940&auto=format&fit=crop')] bg-cover bg-center opacity-40 mix-blend-overlay hover:opacity-60 transition-opacity duration-700"></div>
               </FadeIn>
            </div>
          ...
          <div className="flex flex-col md:flex-row-reverse items-center gap-12 mb-32 relative">
            ...
            <div className="flex-1 w-full pl-8 md:pl-0 md:pl-12">
               <FadeIn className="aspect-[4/3] rounded-2xl border border-white/10 bg-gray-900/50 flex items-center justify-center overflow-hidden relative group">
                  ...
                  <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1522071820081-009f0129c71c?q=80&w=2940&auto=format&fit=crop')] bg-cover bg-center opacity-40 mix-blend-overlay hover:opacity-60 transition-opacity duration-700"></div>
               </FadeIn>
            </div>
